...
const Home = () => {
  ...
  return (
    <Element name="home">
      <section className={`px-8 grid grid-cols-1 pt-8 md:pt-4 md:grid-cols-2 h-full w-full place-items-center ${isDark ? "bg-gray-900" : "bg-white"}`}>
        <div className="flex flex-col justify-center h-full w-full md:w-3/4 px-4 md:px-0">
          <h3 className={`font-kufam text-3xl md:text-4xl mb-4 md:mb-6 font-medium ${isDark ? "text-white" : "text-black"}`}>
            Get the Latest iPhones at Unbeatable Prices!
          </h3>
          <p className={`mb-4 md:mb-6 font-kufam text-sm md:text-base font-normal leading-6 md:leading-7 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
